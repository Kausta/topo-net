...
# Not working atm: https://github.com/omry/omegaconf/issues/1165
...
class ExperimentConfig:
    ...
    test_final: bool = True
    test_best_val: bool = False
...
def load_config(*yamls: Union[str, bytes, os.PathLike], cli_args: list = [], from_string=False, **kwargs) -> Any:
    if from_string:
